        ...
        <div className='col-md-7'>
            <div className='card p-3 py-4'>
                ...
                <div className='text-center mt-3'>
                    ...
                    <h5 class="mt-2">Vivian Lizette Espindola Camargo</h5>
                        <div className='card-block'>
                          <h6 className='m-b-20 p-b-5 b-b-default f-w-600'>Información</h6>
                          <div className='row'>
                              <div className='col-sm-6'>
                                  <p className='m-b-10 f-w-600'>Edad</p>
                                  <h6 className='text-muted f-w-400'>20</h6>
                              </div>
                              <div className='col-sm-6'>
                                  <p className='m-b-10 f-w-600'>Dirección</p>
                                  <h6 className='text-muted f-w-400'>Enrique Arce calle #8</h6>
                              </div>
                              <div className='col-sm-6'>
                              ...
                              <div className='col-sm-6'>
                                  ...
                                  <h6 className='text-muted f-w-400'>Femenino</h6>
                              </div>
                              <div className='col-sm-6'>
                                  <p className='m-b-10 f-w-600'>CI</p>
                                  <h6 className='text-muted f-w-400'>8709906</h6>
                              </div>
                              <div className='col-sm-6'>
                                  <p className='m-b-10 f-w-600'>Expedido</p>
                                  <h6 className='text-muted f-w-400'>Cbba</h6>
                              </div>
                              <div className='col-sm-6'>
